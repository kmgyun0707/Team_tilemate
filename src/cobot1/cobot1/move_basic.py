...
def perform_task():
    ...
    print("move spiral!")
    move_spiral(rev=5,rmax=20,lmax=-10,v=40,a=40,axis=DR_AXIS_Z,ref=DR_TOOL)

    # 반복 동작 수행
    #while True:       
        # 이동 명령 실행
        # Max Radius with Blending
        # move_spiral(rev=5,rmax=20.0,lmax=-10,v=40,a=40,axis=DR_AXIS_Z,ref=DR_TOOL)
        # move_spiral(rev=5,rmax=20.0,lmax=-10,v=40,a=40,axis=DR_AXIS_Z,ref=DR_TOOL)


        # # Coordinate values with Blending
        # move_spiral(rev=5,pos=P2,v=40,a=40,axis=DR_AXIS_Z,ref=DR_BASE)
        # move_spiral(rev=5,pos=P1,v=40,a=40,axis=DR_AXIS_Z,ref=DR_BASE)
